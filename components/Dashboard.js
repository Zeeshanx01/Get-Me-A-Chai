...
const Dashboard = ({ params }) => {
  ...
  return (<>
    ...
    <form action={handleSubmit} className='bg-slate-6000 max-sm:w-[80%] w-[40%] mx-auto my-5 rounded-xl p-2'>
      ...
      <button type="submit" className="text-white bg-gradient-to-r from-purple-700 via-purple-6000 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 shadow-lg font-medium rounded-lg w-full px-12 py-2 text-center my-4">Save</button>
